...
<body>
		...
		<%
			List<Product> list = (List<Product>) request.getAttribute("PROD_LIST");
 ...
 --%>
					...
					<div class="col-2">
				<p>Home / T-Shirt</p>
				<h1> Red Puma Printed T-shirt</h1>
				<h4>1000</h4>
				<select>
				...
				<a href="CartServlet?itemid=1&itemname=Printed t-shirt&itemprice=1000&image src=images/product-1.jpg&quantity=1"
							class="btn" id="myButton1" onclick="change()">Add To Cart </a>
				<h3>
					Product Details <i class="fa fa-indent"></i>
				</h3>
				<br>
				<p>Porduct details from puma</p>
			</div>
				</div>
			</div>
