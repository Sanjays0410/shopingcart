...
<body>
 ...
 <div class="col-2">
			...
			<div class="col-2">
				...
				<a href="CartServlet?itemid=4&itemname=Puma T-Shirt&itemprice=1500&quantity=1&image src=images/product-4.jpg" class="btn" id="myButton1" onclick="change()">Add To Cart </a>
