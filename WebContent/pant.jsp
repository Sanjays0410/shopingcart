...
<body>
 ...
 <div class="col-2">
			...
			<div class="col-2">
				...
				<a href="CartServlet?itemid=3&itemname=Jogger Pant&itemprice=750&quantity=1&image src=images/product-3.jpg" class="btn" id="myButton1" onclick="change()">Add To Cart </a>
				<h3>Product Details <i class="fa fa-indent"></i></h3>
				<br>
				<p>Product details from evqqkkaffvlajefbv</p>
			</div>
		</div>
	</div>
