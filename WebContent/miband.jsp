...
<body>
 ...
 <div class="col-2">
			...
			<div class="col-2">
				...
				<a href="CartServlet?itemid=5&itemname=MI Band&itemprice=1999&quantity=1&image src=images/exclusive.png" class="btn" id="myButton1" onclick="change()">Add To Cart </a>
